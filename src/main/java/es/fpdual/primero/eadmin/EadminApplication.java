...
public class EadminApplication {
	...
	public static void main(String[] args) {
		...
		final DocumentoContable documentoContable = new DocumentoContable(10, "operacion contable", usuario, fecha, "254130287");
		final Documento documento = new DocumentoContable (15, "operacion", usuario, fecha, "5479996633");
